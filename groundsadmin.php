...
<a href= "admin.html"> <button type="submit" class="btn btn-secondary"  >לרשימת המגרשים המלאה</button></a>
<?php
	  echo 
                "<a href='delete.php?del=$groundid' <button type='submit' class='btn btn-danger'  >מחק מגרש</button></a>"; 
?>
