...
$currentUserId = $_SESSION['id'];
  $query="SELECT * FROM tbl_players_203 players INNER JOIN tbl_games_203 games on players.gameid=games.Id INNER JOIN tbl_grounds_203 grounds on games.groundid=grounds.Id WHERE players.userid=$currentUserId";
...
<section>
    ...
    while ($games=mysqli_fetch_object($result)){
      echo "<li class='games'><h4>$games->GroundName</h4><h5> שעות: $games->start-$games->end</h5></li>";
    }
    ?>
