        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="adminform.php">הוספת מגרש</a>
                </li>
                <li class="nav-item">
...
<section>
    ...
    while ($ground=mysqli_fetch_object($result)){
      echo "<li class='filterDiv $ground->SportType' ><a href='groundsadmin.php?id=$ground->Id&name=$ground->GroundName&type=$ground->GroundTypeHeb'><div><h5>";
